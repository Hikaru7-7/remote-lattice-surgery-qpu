...
# ---- frame-level legality rules (recovered from commit 817d051; the seam-fix
# working copy was based on an older file and dropped this block. Re-grafted
# 2026-07-15, unchanged. The visualizer's verify()/write_html call these.) ----
